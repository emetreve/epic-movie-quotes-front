  ...
  return (
    ...
    >
      <div
        ...
        className='h-full lg:mt-[4rem] lg:bg-profile-dark-blue w-full lg:h-fit lg:pb-10 lg:w-[54rem] lg:rounded-2xl relative lg:scale-105'
      >
        ...
        <div className='px-7 mt-6 lg:px-[2rem]'>
          <div className='flex flex-row items-center lg:mb-4'>
            <Image
              ...
              width={512}
              height={512}
              className='h-11 w-11 mr-3 lg:h-[3.8rem] lg:w-[3.8rem] lg:ml-2 ml-1 rounded-[50%]'
            />
